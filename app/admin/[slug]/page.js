    ...
    <>
      {!isLoggedIn ? (
        ...
        <>
          <button
            onClick={logout}
            className=" text-white text-4xl absolute top-6 right-0 "
          >
            <AiOutlineLogout />
          </button>
          ...
          <div className="flex flex-col">
            <h1
              style={{ fontFamily: "Alice", fontWeight: 400, fontSize: "30px" }}
            ...
            <div className="w-full md:w-1/5 px-3">
              ...
              />
              <button
                className="text-black border border-white my-5 w-20 rounded-lg"
                onClick={() => postDetails()}
              >
                upload
              </button>
          ...
          <h1 className="text-white text-4xl font-bold text-center mt-4">
            Your Published Data
          </h1>
                  ...
                  data.map((item) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className=" text-black mt-6 text-3xl"
                      >
                        <MdDelete />
                      </button>
                    </tr>
